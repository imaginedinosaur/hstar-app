    ...
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto pb-20">
        ...
        <div className="mx-3 mb-4 bg-blue-50 rounded-lg p-4 flex justify-between items-center relative overflow-hidden">
           ...
           {/* Decorative graphics mimicking the building illustration */}
      ...
      {/* Bottom Navigation */}
      <div className="bg-white border-t border-gray-200 flex justify-around py-2 text-xs text-gray-500 absolute bottom-0 w-full">
...
const EducationList = ({ onNavigate }) => {
  return (
    <div className="flex flex-col h-full bg-gray-100">
      ...
      <div className="flex-1 overflow-y-auto p-3">
        ...
        <div className="flex justify-between items-end mb-2">
           <h3 className="text-gray-800 font-medium text-lg">学籍信息 (2)</h3>
           <span className="text-xs text-teal-600">还有学籍没有显示出来？ <span className="underline">尝试绑定</span></span>
        </div>

        {/* Card 1: Master's */}
        <div className="bg-[#28c495] rounded-lg p-4 mb-3 shadow-sm text-white relative overflow-hidden">
           <div className="flex justify-between items-start">
              <div>
                 <h2 className="text-xl font-medium mb-2">河海大学</h2>
              ...
              <span className="bg-black/10 text-xs px-2 py-1 rounded-full">硕士研究生</span>
           </div>
        </div>

        {/* Card 2: Undergraduate - CLICKABLE */}
        <div 
        ...
        >
           <div className="flex justify-between items-start">
              ...
              <span className="bg-black/10 text-xs px-2 py-1 rounded-full">本科</span>
           </div>
        </div>
...
const StudentDetail = ({ onNavigate }) => {
  return (
    <div className="flex flex-col h-full bg-white">
      {/* Header - White for this page */}
      ...
      <div className="flex-1 overflow-y-auto">
           ...
           <div className="flex gap-4 mb-4">
              <div className="flex flex-col items-center gap-1">
                 <div className="w-16 h-20 bg-gray-200 rounded border-2 border-white overflow-hidden">
                    <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=XueWenbo&gender=male" alt="Admit" className="w-full h-full object-cover" />
                 </div>
                 <span className="text-[10px] opacity-80">录取照片</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                 <div className="w-16 h-20 bg-gray-200 rounded border-2 border-white overflow-hidden">
                     <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=XueWenbo2&gender=male" alt="Degree" className="w-full h-full object-cover" />
                 </div>
                 <span className="text-[10px] opacity-80">学历照片</span>
              </div>
              
              <div className="ml-2 pt-1">
                 <h2 className="text-xl font-medium mb-1">薛文博</h2>
                 <p className="text-sm opacity-90">男 &nbsp; 2002年01月27日</p>
              </div>
           </div>

           <div className="mt-2">
              <h3 className="text-xl font-medium mb-1">河海大学</h3>
              <div className="flex justify-between items-center">
                 ...
                 <span className="bg-black/10 px-2 py-0.5 rounded text-xs">本科</span>
              </div>
           </div>
        </div>
        ...
        <div className="p-6 space-y-4 text-sm text-gray-500">
           <DetailRow label="民族" value="汉族" />
           <DetailRow label="证件号码" value="150102200201274612" />
           <DetailRow label="学制" value="4 年" />
           <DetailRow label="学历类别" value="普通高等教育" />
           <DetailRow label="分院" value="0" />
           <DetailRow label="系所" value="水利水电学院" />
           <DetailRow label="班级" value="水工20-2" />
           <DetailRow label="学号" value="2002010229" />
           <DetailRow label="入学日期" value="2020年09月07日" />
           <DetailRow label="学籍状态" value="不在籍（毕业）" />
           <DetailRow label="离校日期" value="2024年06月21日" />
        </div>
...
const DetailRow = ({ label, value }) => (
  <div className="flex">
     <span className="w-24 text-right mr-6 text-gray-400">{label}</span>
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-200 font-sans">
      ...
      <div className="w-full max-w-[400px] h-[850px] bg-white relative shadow-2xl overflow-hidden flex flex-col">
        {/* Status Bar Simulator (Top of phone) */}
        <div className="bg-black text-white px-4 py-1 flex justify-between items-center text-[10px] shrink-0 z-50">
           <span>16:15</span>
        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          {currentPage === 'list' && <EducationList onNavigate={setCurrentPage} />}
          {currentPage === 'detail' && <StudentDetail onNavigate={setCurrentPage} />}
        </div>
        
        {/* Navigation Bar Simulator (Bottom of phone) - Visual only */}
        <div className="h-4 bg-white shrink-0 flex justify-center items-center">
